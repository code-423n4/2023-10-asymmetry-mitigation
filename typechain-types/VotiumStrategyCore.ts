...
export interface VotiumStrategyCoreInterface extends utils.Interface {
  functions: {
...
export interface VotiumStrategyCore extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VotiumStrategyCoreInterface;
